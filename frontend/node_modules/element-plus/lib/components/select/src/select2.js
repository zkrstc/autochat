  ...
  setup(props, { emit, slots }) {
    ...
    const manuallyRenderSlots = (vnodes) => {
      ...
      children.filter((item) => {
        return shared.isObject(item) && item.type.name === "ElOption";
      }).forEach((item) => {
    ...
    vue.watchEffect(() => {
      if (!props.persistent) {
        vue.nextTick(() => {
          var _a, _b;
          const defaultSlots = vue.h(vue.Fragment, (_b = (_a = slots.default) == null ? void 0 : _a.call(slots)) != null ? _b : []).children;
